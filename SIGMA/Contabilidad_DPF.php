...
<?
$bamco=$_POST["bamco"];
$F_emi_usu=$_POST["FEmision"];
$F_ven_usu=$_POST["FVencimiento"];
			
$fe = explode("-",$F_emi_usu); $fea=$fe[0]; $fem=$fe[1];  $fed=$fe[2];
$fv = explode("-",$F_ven_usu); $fva=$fv[0]; $fvm=$fv[1]; $fvd=$fv[2];
	   ...
	   <form id="form1" name="form1" method="post" action="Contabilidad_DPF.php">
			...
			<table  border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td></td>
						<td>
							Fecha Desde:<?echo $fed,("-"),$fem,("-"),$fea;?>
						</td>
						<td>
							Fecha Hasta:<?echo $fvd,("-"),$fvm,("-"),$fva;?>
						</td>
				</tr>
...
echo $bamco=$_POST["bamco"];
echo $F_emi_usu=$_POST["FEmision"];
echo $F_ven_usu=$_POST["FVencimiento"];
...
<!--<div style=" border:0px solid blue; width:1100px; height:200px; overflow-x:hidden; overflow-y:scroll;" >-->
<div style=" border:0px solid blue; width:1100px; height:200px; overflow-x:scroll; overflow-y:scroll;" >
