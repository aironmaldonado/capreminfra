...
<div align="center">
 ...
 $cod;
 $b = mysql_query ("UPDATE  dividendos_pendiente SET  estatus =  'i'  where estatus='a' and cod_dividendos_pendiente='$cod' ",$conexadmi); 
	
if($b)
	{
echo "<script type='text/javascript'>alert('Fue colocado inactivo  '); document.location.href = ('dividendos_pendiente2.php'); </script>";
	
	}
else 
	{
	echo "<script type='text/javascript'> alert('Error en la actualización.'); document.location.href = ('Registro_Socios.php'); </script>";
	}
