...
document.form1.href = ('inicio.php'); 
	...
	else if(document.form2.direccion.value.length==0){
		alert("Defina Direccion");
...
switch ($mancom) {
		case "mancomunado":
					...
					VALUES ('null', '$cedulaS', '$cod_solicitudes', '$usunom $usuapel', 'Realizo la solicitud Antención al Socio:$obs', '$nombre_pc' , '$id_usu','Atención Al Socio'), ('null', '$cedula2', '$cod_solicitudes2', '$usunom $usuapel', 'Realizo la solicitud crédito observaciones:$obs', '$nombre_pc', '$id_usu','Atención Al Socio' ) ",$conexadmi);
...
<table align="center"   border="0" cellpadding="0" cellspacing="0">
							...
							?>
			<form id="form" name="form" method="post" action="Solicitud_Credito_Hipotecario1.php">	
			
				</br>
				<tr>
				  <td colspan="2" align="center" id="titulo2" >Solicitud de  Credito Hipotecario</td>
				</tr>
				...
				<tr>
							...
							<td>
								...
								<select  name="tipo_prestamos"  onchange="submit();"  id="tipo_prestamos" >
								  ...
								  <?$buscar = mysql_query ("SELECT * FROM `tipo_prestamos` WHERE  `prestamo`='HIPOTECARIO' and `status_tipo_prestamos`=1 ",$conexPres);?>
...
<form id="form1" name="form1" method="post" action="Solicitud_Credito_Hipotecario1.php">
...
<table align="center"  >
			...
			<form  method="post" action="Solicitud_Credito_Hipotecario1.php">	
				<tr>
...
<form id="form1" name="form1" method="post" action="Solicitud_Credito_Hipotecario1.php">			
				...
				<tr>
					<td>
						Direcciòn del Inmueble:
					</td>
					<td colspan=4>
					<textarea name="direccion" rows="2" cols="44"> </textarea>
					<!--<input  type="text" name="direccion" size="22" maxlength="9" value="" onKeyPress="return permite(event,'car')" > -->
					</td>
				</tr>				
				<tr>
					<td>
...
<table align="center">
<form id="form2" name="form2" method="post" action="Solicitud_Credito_Hipotecario1.php">			
				<tr>
				...
				<tr>
					...
					<td>
					<textarea name="direccion" rows="2" cols="44"> </textarea>
					<!--<input type="text" name="direccion" size="11" maxlength="9" value="" onKeyPress="return permite(event,'car')" > -->
					</td>
				</tr>				
				<tr>
					<td>
				...
				<tr>   
					<td colspan=4 align="center" >
						 ...
						 <input name="boton1" type="HIDDEN" id="boton1" />
						 <input name="modificar" type="button" id="modificar" value="Guardar2" onClick="guardar2()" />
						 <input name="boton2" type="HIDDEN" id="boton2" />
						 <input name="Regresas" type="button" id="Regresas" value="Regresas2" onclick="regresas()" />
					</td>                                
				</tr>
				<?}?>
</table>
