function permite(elEvento,permitidos){
   ...
   var sig = "-";
    var caracteres_rif = "JGgj";
   var numeros_caracteres = numeros + caracteres;
   
   var rif_numeros_caracteres = numeros + caracteres_rif;
   
    var numeros_sig = numeros + sig;
   ...
   switch(permitidos){
      ...
      break;
	  case 'rif':
         permitidos = rif_numeros_caracteres;
      break;
   }
