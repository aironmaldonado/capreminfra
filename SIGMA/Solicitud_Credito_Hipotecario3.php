...
*/
					...
					if($consulta1){
							...
							echo "<script type='text/javascript'> alert('Su Solicitud ha sido enviada satisfactoriamente, recuerde imprimir la planilla y enviar junto con los recaudos correspondientes');document.location.href = ('Solicitud_Credito_Hipotecario4.php'); </script>";
...
?>
 ...
 <form id="form1" name="form1" method="post" action="Solicitud_Credito_Hipotecario3.php">
