...
$b = mysql_query ("SELECT * FROM telefono as tel inner join codigo_area as ca on(tel.cod_codigo_area=ca.cod_codigo_area) where cedula='$cedulaS';  ",$cn);
 ...
 $personas =mysql_query("SELECT Nom_Ape, nombre1, nombre2, apellido1, apellido2, nacionalidad, cedula, sexo, N_cuenta,F_ingreso, F_nacimiento, correo, nom_estatus, tipo_nomina, nom_organismo, est_civil, direccion, estado, municipio, parroquia, tipo_vivienda
FROM  `socios` AS soc
...
/*-------------------------------------------------------------------------------------------------------------*/
		...
		/*--------------- credito ------------------------------*/	
					...
					$conexSC = mysql_connect("127.0.0.1","root","1234");
					mysql_select_db("prestamos",$conexSC);
					$b = mysql_query ("SELECT Max(cod_analisis_hipotecario) as cod_ana_hipo FROM `analisis_hipotecario` where id_analisis_hipotecario= '$cedulaS' and opcion='1' and status_Analisis_hipotecario='Activa' ",$conexSC); while($v=mysql_fetch_assoc($b))	{	$cod_ana_hipo=$v['cod_ana_hipo']; 	}	
					
				
					
					$b = mysql_query ("SELECT * FROM analisis_hipotecario WHERE cod_analisis_hipotecario = '$cod_ana_hipo'  ",$conexSC);
					while($v=mysql_fetch_assoc($b))	
					{  
					$monto=$v['monto'];
					...
					$conexSC = mysql_connect("127.0.0.1","root","1234");
					mysql_select_db("prestamos",$conexSC);
					$b = mysql_query ("SELECT Max(cod_analisis_hipotecario) as cod_ana_hipo FROM `analisis_hipotecario` where id_analisis_hipotecario= '$cedulaS' and opcion='2' and status_Analisis_hipotecario='Activa' ",$conexSC); while($v=mysql_fetch_assoc($b))	{	$cod_ana_hipo=$v['cod_ana_hipo']; 	}	
					...
					$conexSC = mysql_connect("127.0.0.1","root","1234");
					mysql_select_db("prestamos",$conexSC);
					$b = mysql_query ("SELECT Max(cod_analisis_hipotecario) as cod_ana_hipo FROM `analisis_hipotecario` where id_analisis_hipotecario= '$cedulaS' and opcion='3' and status_Analisis_hipotecario='Activa' ",$conexSC); while($v=mysql_fetch_assoc($b))	{	$cod_ana_hipo=$v['cod_ana_hipo']; 	}	
...
/*-------------------------------------------------------------------------------------------------------------*/
	...
	$b = mysql_query ("SELECT * FROM unidades_tributaria WHERE  cod_unidad_tributaria= '1'  ",$conexSC);
					...
					$conexSC = mysql_connect("127.0.0.1","root","1234");
					mysql_select_db("prestamos",$conexSC);
					$b = mysql_query ("SELECT * FROM  `vivienda` WHERE  `cod_solicitudes` ='$cod_solicitudes' ",$conexSC); while($v=mysql_fetch_assoc($b))	{	$direccion_c_compra=$v['direccion']; 	}	
...
/*----------------------------------------------------inicio ---------------------------------------------------------*/
			...
			//utf8_decode("$cod_solicitudes")	$tipo_prestamo
...
/*---------tercer cuadro-----------*/
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont("arial","",10);	
	$pdf->Cell(80.2,4,utf8_decode("Datos de la Vivienda"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(0,0,128);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont("arial","",10);	
	$pdf->Cell(80,4,utf8_decode("Datos del Credito"),1,0,"C",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(30,5,utf8_decode("Monto Del Avalúo"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(50,5,number_format($monto_avaluo, 2, ",", ".").' Bs',1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,utf8_decode("Monto Solicitado"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,number_format($monto_solicitado, 2, ",", ".").' Bs',1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','B',9);
	$pdf->Cell(30,5,utf8_decode("Tipo de Crédito:"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','B',9);
	$pdf->Cell(50,5,"$tipo_prestamo",1,0,"L",1);
	*/
	$pdf->Ln(4);
	$pdf->Cell(10);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(30,5,utf8_decode("Ing.Responsable:"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(50,5,utf8_decode("WILMER FLORES"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,utf8_decode("Plazo:"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,utf8_decode("$plazo Años") ,1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(80,5,utf8_decode("Dir.: $direccion_c_compra "),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,utf8_decode("Nº Cuotas:"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(40,5,"$N_cuota",1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(62,5,utf8_decode("SEGURO"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(53,5,utf8_decode("TOTALES"),1,0,"C",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,utf8_decode("Monto Bs."),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,utf8_decode("Cuota M."),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,utf8_decode("Incendio (I)"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,utf8_decode("Vida (V)"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(21.7,5,utf8_decode("Total (I+V/12) "),1,0,"C",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28,5,utf8_decode("Cuo. Mensual"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24.9,5,utf8_decode("% sobre el neto"),1,0,"L",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(5,5,utf8_decode("S1"),1,0,"L",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($monto, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($cut_mensual, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_incendio, 2, ",", ".") ,1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_vida, 2, ",", ".") ,1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(21.8,5,number_format($total_inc_vid, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28,5,number_format($total_cuo_mens, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(25,5,number_format($total_sobre_neto, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(6.4 ,5,"" ,1,0,"C",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(5,5,utf8_decode("A"),1,0,"L",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($monto1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($cut_mensual1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_incendio1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_vida1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(21.8,5,number_format($total_inc_vid1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28,5,number_format($total_cuo_mens1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(25,5,number_format($total_sobre_neto1, 2, ",", "."),1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(5,5,utf8_decode("B"),1,0,"L",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($monto2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($cut_mensual2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_incendio2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(20,5,number_format($seg_vida2, 2, ",", "."),1,0,"R",1);

	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(21.8,5,number_format($total_inc_vid2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28,5,number_format($total_cuo_mens2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(25,5,number_format($total_sobre_neto2, 2, ",", "."),1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(6,4,utf8_decode(""),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,utf8_decode("Gasto Avalúo"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(17,4,utf8_decode("Gastos Op."),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28.5,4,utf8_decode("Pólizas (I+V*12)"),1,0,"C",1);

	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,utf8_decode("Notaria"),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,utf8_decode("Gastos Viatico."),1,0,"C",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,utf8_decode("Total Gasto"),1,0,"C",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,utf8_decode("Monto Che."),1,0,"C",1);
...
switch ($cod_prestamo) {
    ...
    case 7:
       $M_cheque=$monto-($G_operacionales+$T_poliza+$notaria+$perito);
	    $M_cheque1=$monto1-($G_operacionales1+$T_poliza+$notaria1+$perito);
		$M_cheque2=$monto2-($G_operacionales2+$T_poliza+$notaria2+$perito);
	   	
		$total_gas=($G_operacionales+$T_poliza+$notaria+$perito);
	    $total_gas1=($G_operacionales1+$T_poliza+$notaria1+$perito);
		$total_gas2=($G_operacionales2+$T_poliza+$notaria2+$perito);
	  
        break;
		
    case 8:
	
	 $M_cheque=$monto-($G_operacionales+$T_poliza+$notaria+$T_Gastos+$perito);
	    $M_cheque1=$monto1-($G_operacionales1+$T_poliza+$notaria1+$T_Gastos1+$perito);
		$M_cheque2=$monto2-($G_operacionales2+$T_poliza+$notaria2+$T_Gastos2+$perito);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,number_format($perito, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(17,4,number_format($G_operacionales, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28.5,4,"$T_poliza",1,0,"R",1);

	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,number_format($notaria, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,number_format($T_Gastos, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,number_format($total_gas, 2, ",", "."),1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,number_format($M_cheque, 2, ",", "."),1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(17,4,number_format($G_operacionales1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28.5,4,"$T_poliza1",1,0,"R",1);

	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,number_format($notaria1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,number_format($T_Gastos1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,number_format($total_gas1, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,4,number_format($M_cheque1, 2, ",", "."),1,0,"R",1);
	...
	*/
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(6,5,utf8_decode("B"),1,0,"L",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,5,number_format($perito, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(17,5,number_format($G_operacionales2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(28.5,5,"$T_poliza2",1,0,"R",1);

	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,5,number_format($notaria2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,5,number_format($T_Gastos, 2, ",", ".") ,1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(18,4,number_format($total_gas2, 2, ",", "."),1,0,"R",1);
	
	$pdf->Cell(0.1);
	$pdf->SetTextColor(8,8,8);
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(24,5,number_format($M_cheque2, 2, ",", ".") ,1,0,"R",1);
	...
	$pdf->SetFillColor(255,255, 255);
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(53.3,5,utf8_decode("Consultoria Jurídica"),1,0,"C",1);
