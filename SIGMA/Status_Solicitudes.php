...
$consulta=mysql_query(" UPDATE  solicitudes SET  status_solicitud = 'Devuelto' WHERE  cod_solicitudes ='$cod_solicitudes'  ;",$conexPres);			
...
<form id="form1" name="form1" method="post" action="Status_Solicitudes.php" >
