...
if($cod_cedula)
	{
echo "<script type='text/javascript'> document.location.href = ('Actualizar_Socios1.php'); </script>";
...
<div>
	   ...
	   <form id="form1" name="form1" method="post" action="Actualizar_Socios.php">
